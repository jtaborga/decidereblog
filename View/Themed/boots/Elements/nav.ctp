...
<nav class="navigation navigation-inverse">
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
  	<div class="container">
		...
		<div class="text-center">
			<span class="menu-desktop">
				<a class="a-login" href="/decidereblog/admin/">Log In</a>
	        	<!--a class="a-login" data-toggle="modal" data-target="#myModal">Log In</a-->
	        </span>
	        <span class="menu-desktop2">
	        	<a class="hvr-pulse-grow" href="../decidere/Register/"><?php echo $this->Html->image('btn-join.png', $options = array('class'=>'animated rubberBand', 'alt'=>'Join')); ?></a>
